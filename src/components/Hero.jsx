...
const Hero = () => (
  <section id="home" className={`${styles.paddingY} flex flex-container md:flex-row flex-col`}>
    {/* Left side */}
    <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
      ...
      <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
        ...
        needs. We examine annual percentage rates and fees.
      </p>
    </div>
    ...
    <div>
      ...
      <div className="absolute z-[1] w-[80%] h-[80%] bottom-40 white__gradient round-full" />
